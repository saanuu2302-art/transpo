  ...
  en: {
    ...
    owner: {
        ...
        transactions: {
            ...
            description: 'View your transaction history and manage payouts.',
  ...
  kn: {
    ...
    owner: {
        ...
        requests: {
            ...
            noRequests: 'ಯಾವುದೇ ಬಾಕಿ ಇರುವ ಬುಕಿಂಗ್ ವಿನಂತಿಗಳಿಲ್ಲ.',
            farmer: 'ರೈತ',
            date: 'ದಿನಾಂಕ',
            approve: 'ಅನುಮೋದಿಸಿ',
            reject: 'ತಿರಸ್ಕರಿಸಿ',
        ...
        transactions: {
            title: 'ಗಳಿಕೆಗಳು ಮತ್ತು ಪಾವತಿಗಳು',
            description: 'ನಿಮ್ಮ ವಹಿವಾಟಿನ ಇತಿಹಾಸವನ್ನು ವೀಕ್ಷಿಸಿ ಮತ್ತು ಪಾವತಿಗಳನ್ನು ನಿರ್ವಹಿಸಿ.',
        ...
        profile: {
            ...
            editDescription: 'ನಿಮ್ಮ ಹೆಸರು ಮತ್ತು ಖಾತೆಯ ವಿವರಗಳನ್ನು ನವೀಕರಿಸಿ.',
            changePhoto: 'ಫೋಟೋ ಬದಲಾಯಿಸಿ',
